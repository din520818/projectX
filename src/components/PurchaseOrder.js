  ...
  const handleClose = () => {
    ...
    return (
      ...
      <MaterialTable
        ...
        data={[
          { orderNo: '1', orderDate: '1/18/2020', deliveryDate: '3/18/2020', supplier: 34, amount:'55,555' },
          { orderNo: '2', orderDate: '2/18/2020', deliveryDate: '5/18/2020', supplier: 63, amount: '66,666' },
        ]}        
        actions={[
          {
            icon: 'add',
